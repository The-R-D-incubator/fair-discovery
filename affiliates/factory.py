...
def build_ultimate_portal(folder_name, title, keywords):
    # Ensure the root affiliates folder exists first
        ...
        with open(f"{base_path}/{filename}", "w") as art:
            ...
            <head>
                ...
                {{
                  ...
                  "@type": "Product",
                  "name": "{k}",
                  "description": "Professional review and procurement guide.",
            ...
            <body>
                ...
                <div class="container">
                    ...
                    <p>Verified hardware for users across the USA, UK, Canada, EU, and South Africa.</p>
                    ...
                    <div class="cta-box">
                        <a href="{HONEYGAIN_URL}" style="color:#00d18a;">Claim $5 Honeygain Bonus →</a>
                    </div>
                </div>
            </body>
            </html>
...
if __name__ == "__main__":
    build_ultimate_portal("pro-solar", "Energy Systems", ["Solar Inverter", "Lithium Battery", "Solar Panels"])
    build_ultimate_portal("auto-tech", "Vehicle Diagnostics", ["OBD2 Scanner", "ECU Tuner"])
    build_ultimate_portal("star-gear", "Starlink Accessories", ["Starlink Mount", "Travel Case"])
    build_ultimate_portal("home-defense", "Smart Security", ["Video Doorbell", "Smart Lock"])
